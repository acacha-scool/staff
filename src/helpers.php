...
if (! function_exists('seed_positions')) {
    ...
    function seed_positions()
    {
        ...
        position_first_or_create('CC pag.web-');
        ...
        position_first_or_create('CC Audiovosials');
        ...
        position_first_or_create('Cap de seminari Informàtica');
        ...
        position_first_or_create('Tutor 1SMX A/C');
        position_first_or_create('Tutor 2ASIX');
        position_first_or_create('Tutor 2SMX A/B');
        position_first_or_create('Tutor 2Pro/1EE');
        ...
        position_first_or_create('Cap. seminati Fabric. Mec.');
        position_first_or_create('Cap. Dep. Fabric. Mec. / Mant.');
        ...
        position_first_or_create('Cap. DEP. Sanitat');
        ...
        position_first_or_create('Tutor 2 FAR');
        ...
        position_first_or_create('Tutor 1INS B');
        position_first_or_create('Tutora 2INS B');
        position_first_or_create('Coord. pedagògica');
        position_first_or_create('Tutor 2INS A');
        position_first_or_create('Cap Semenari Serv. Com.');
        position_first_or_create('Tutor 1EIN');
        position_first_or_create('Cap. Dep. Serv. Com.');
        position_first_or_create('Tutora 1INS A');
        position_first_or_create('Tutora 1DEP');
        position_first_or_create('Cap. dep. Arts Gràf.');
        position_first_or_create('Tutor 2PRID');
        position_first_or_create('Tutora 1Prid');
        position_first_or_create('Tutora 2MAP');
        position_first_or_create('Tutora 2ACO-Resp.');
        position_first_or_create('Tutor 2APD');
        position_first_or_create('Tutor 1SMX');
    }
}
